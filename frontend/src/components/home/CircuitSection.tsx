    ...
    <section className="px-4 sm:px-8 py-10">
      ...
      <div className="grid md:grid-cols-2 gap-4 mt-6">
        <div className="card overflow-hidden">
          <img src="/media/circuit1.webp" alt="Circuit 1" loading="lazy" className="w-full h-56 object-cover" />
          <div className="p-4">
        ...
        <div className="card overflow-hidden">
          <img src="/media/circuit2.webp" alt="Circuit 2" loading="lazy" className="w-full h-56 object-cover" />
          <div className="p-4">
