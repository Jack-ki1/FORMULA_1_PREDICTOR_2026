      ...
      <div className="navy-panel rounded-xl p-6 sm:p-8 text-white relative overflow-hidden">
        <div className="grid md:grid-cols-3 gap-6 items-center relative">
          <div className="text-center">
            <img src="/media/racer1.webp" alt="Racer A" loading="lazy" className="w-32 h-32 mx-auto rounded-full object-cover border-4 border-white/20 shadow-xl" />
          ...
          <div className="text-center">
            <img src="/media/racer2.webp" alt="Racer B" loading="lazy" className="w-32 h-32 mx-auto rounded-full object-cover border-4 border-white/20 shadow-xl" />
